				...
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="index.html">
							<h1><span class="fa fa-comments-o" aria-hidden="true"></span>Lively Smail <label>For Customer Support</label></h1>
						</a>
					</div>
					<!--/.navbar-header-->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="login_action.php">Send Mail</a>
								</li>
								<li><a href="mail.php">View Mail's</a>
								</li>
								<li><a href="/mail/demo/key_gen.php">Key Generation</a></li>
...
$result = $conn->query($sql);
	 ...
	 while($row = $result->fetch_assoc()) {
	 	echo "<tr>
			  <td>".$row["id"]."</td>
			  <td>".$row["Sender"]."</td>
              <td><textarea cols='30' rows='10'>".$row["message"]."</textarea></td></tr>";
            }
