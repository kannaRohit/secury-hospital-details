...
<body>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="login_action.php">Send Detail's</a>
								</li>
								<li><a href="login_action.php">View Detail's</a>
								</li>
	...
	<div class="services-breadcrumb_w3ls">
		<div class="inner_breadcrumb">
			...
			<ul class="short">
				<li><a href="/mail/index.html">Home</a><span>|</span></li>
				<li>logout</li>
			</ul>
		</div>
	</div>
